      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="lib/datosUMH.php"><i class="fa fa-university"></i><span>Datos UMH</span></a></li>
            <li><a href="#"><i class="fa fa-group"></i> <span>Datos Centros</span></a></li>
            <li class="treeview">
